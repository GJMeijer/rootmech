---
title: "powerlaw_lognormal_uncorrected_fit"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{powerlaw_lognormal_uncorrected_fit}
...
We want to fit a series of $x$,$y$ data using a power law which describes the log-mean of $y$ at each value of $x$: $$ \bar{y} = y_0 x^\beta $$. The residuals are described using a log-normal distribution.
